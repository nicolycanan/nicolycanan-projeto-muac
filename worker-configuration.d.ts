/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 6701dd888698b6acf3e3d54c2f809c3c)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 global_fetch_strictly_public
interface __BaseEnv_CloudflareEnv {
	muac_analytics: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	MUAC_SITE_PASSWORD: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "MUAC_SITE_PASSWORD">> {}
}
